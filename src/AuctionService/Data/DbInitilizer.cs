...
public class DbInitilizer
{
    public static void InitDb(WebApplication app)
    {
        ...
        SeedData(scope.ServiceProvider.GetService<AuctionDbContexct>());
    }

    private static void SeedData(AuctionDbContexct contexct)
    {
        contexct.Database.Migrate();
        if (contexct.Auctions.Any())
        {
            System.Console.WriteLine("Already seeded");
            return;
        }
  ...
  new Auction
        ...
        contexct.AddRange(auctions);
        contexct.SaveChanges();
    }
}
